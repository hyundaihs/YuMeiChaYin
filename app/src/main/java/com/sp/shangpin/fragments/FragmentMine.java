...
import com.sp.shangpin.ui.GetCashLogActivity;
...
//            "我的返佣提现",
            "分享"};
    private int[] IDS = {R.mipmap.ids_top_up, R.mipmap.ids_get_cash,R.mipmap.ids_get_cash, R.mipmap.ids_upgrade_orders, R.mipmap.ids_gold_orders,
